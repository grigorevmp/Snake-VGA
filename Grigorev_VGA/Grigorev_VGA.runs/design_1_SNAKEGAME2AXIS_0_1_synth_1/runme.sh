...
HD_PWD='D:/Coding/Vivado/Snake-VGA/Grigorev_VGA/Grigorev_VGA.runs/design_1_SNAKEGAME2AXIS_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SNAKEGAME2AXIS_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SNAKEGAME2AXIS_0_1.tcl
