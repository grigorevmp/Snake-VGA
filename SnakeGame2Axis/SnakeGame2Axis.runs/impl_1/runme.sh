...
HD_PWD='D:/Coding/Vivado/Snake-VGA/SnakeGame2Axis/SnakeGame2Axis.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SNAKEGAME2AXIS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SNAKEGAME2AXIS.tcl -notrace
