...
HD_PWD='D:/Coding/Vivado/Snake-VGA/SnakeGame2Axis/SnakeGame2Axis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SNAKEGAME2AXIS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SNAKEGAME2AXIS.tcl
